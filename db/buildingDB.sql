...
CREATE TABLE `contractors` (
  ...
  `contractor_name` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `contractor_work_details` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `contractor_work_unit` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `contractor_work_quantity` int(50) DEFAULT NULL,
  `contractor_unit_price` decimal(40,2) DEFAULT NULL,
  `contractor_work_total` decimal(60,2) DEFAULT NULL,
...
CREATE TABLE `employees` (
  ...
  `employee_job` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `employee_phone_num` varchar(300) CHARACTER SET utf8 DEFAULT NULL,
  `employee_day_price` decimal(60,2) DEFAULT NULL,
...
CREATE TABLE `extras` (
  `id` int(11) NOT NULL,
  `extra_time` decimal(60,2) DEFAULT NULL,
  `extra_time_price` decimal(60,2) DEFAULT NULL,
  `extra_total_price` decimal(60,2) DEFAULT NULL,
...
CREATE TABLE `managers` (
  ...
  `manager_outlay_amount` decimal(60,2) DEFAULT NULL,
...
CREATE TABLE `projects` (
  ...
  `project_address` varchar(2000) DEFAULT NULL,
...
CREATE TABLE `purchases` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `purchase_name` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `purchase_details` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `purchase_type` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `purchase_unit_price` decimal(20,2) DEFAULT NULL,
  `purchase_unit_quantity` int(60) DEFAULT NULL,
...
CREATE TABLE `statements` (
  `id` int(11) NOT NULL,
  `statement_unit` varchar(200) DEFAULT NULL,
  `statement_unit_price` decimal(20,2) DEFAULT NULL,
  `statement_unit_quantity` varchar(200) DEFAULT NULL,
  `contractor_id` int(60) DEFAULT NULL,
  `employee_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2022-05-08 21:38:26
